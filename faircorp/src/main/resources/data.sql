INSERT INTO BUILDING(id, name) VALUES(100, 'Building1');
INSERT INTO BUILDING(id, name) VALUES(150, 'Building1');
INSERT INTO ROOM(id, name, floor, current_temperature, target_temperature, building_id)  VALUES(-10, 'Room1', 1, 22.3, 20.0,100);
INSERT INTO ROOM(id, name, floor, current_temperature, target_temperature, building_id)  VALUES(10, 'Room2', 1, 2, 21,150);
